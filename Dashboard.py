...
@st.cache_data
def load_overview():
    df_overview = pd.read_excel('../BatteryAnalytics/Inputdata/MeasurementData/Overview.xlsx')
...
def load_combined_trip():
    df_combinedTrip = pd.read_csv('../BatteryAnalytics/Inputdata/MeasurementData/CombinedData.csv')
...
@st.cache_data
def load_master():
    df_master = pd.read_csv('../BatteryAnalytics/Inputdata/MeasurementData/CombinedData.csv')  # Example file path
